...
public class MainInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        currentDate.setPreferredSize(new java.awt.Dimension(250, 22)); // Fixed size to prevent layout changes
        ...
        currentAge.setPreferredSize(new java.awt.Dimension(200, 22)); // Fixed size for years-only display
        currentAge.setHorizontalAlignment(javax.swing.SwingConstants.LEFT); // Left align to prevent button shifting
    ...
    private void calculateActionPerformed(java.awt.event.ActionEvent evt) {                                          
        try {
            ...
            // Calculate age using Java's Period class
            Period period = Period.between(dob, now);
            currentAge.setText(String.format("Your Age - %d years", period.getYears()));
